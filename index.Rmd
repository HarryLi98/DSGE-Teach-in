...
- pDSGE models can be used to explain and predict co-movements of aggregate time series over the business cycle as well as to perform policy analysis. DSGE models are also a prominent tool for forecasting - almost every central bank has some DSGE model, such as the Bank of England's COMPASS. Therefore, it's useful to understand how these models work.
