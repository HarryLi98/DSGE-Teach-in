...
Heuristically, the transversality condition prevents the overaccumulation of savings. 

The transversality condition is an optimality condition and must be satisfied in order for the individual to maximize its intertemporal utility. Just as in a finite horizon model, i
