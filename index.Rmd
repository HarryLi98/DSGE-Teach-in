...
### Assumptions 
- $u'>0, u''<0, \lim_{c \to 0}$
- $u'(c) = \infty, \lim_{c \to \infty} u'(c) = 0$
...
- The next set of assumptions on the utility function are known as the Inada conditions, which are also frequently assumed. The role of these conditions is to ensure the existence of an interior equilibrium. $\lim_{c \to 0} u'(c) = \infty$ implies that the first unit of consumption is infinitely beneficial to the household. $\lim_{c \to \infty} u'(c) = 0$ implies that the marginal utility from consumption is $0$ when consumption is infinite. The interpretation for this might be that you die of starvation if you consuming nothing, which gives $-\infty$ utility, since dying is very undesirable.
...
### Assumptions 
- $u'>0, u''<0$
- $\lim_{c \to 0} u'(c) = \infty, \lim_{c \to \infty} u'(c) = 0$
